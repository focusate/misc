...
class TestIrConfigParameter(TestOdootilCommon):
    ...
    def test_get_param_eval_5(self):
        ...
        with self.assertRaises(AccessError):
            self.Odootil.sudo(self.user_demo).get_param_eval(
                'test.some.param.1')
